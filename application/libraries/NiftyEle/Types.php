...
class PriceUpdateList {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem26 = null;
              $elem26 = new \NiftyEle\PriceUpdateUpc();
              $xfer += $elem26->read($input);
              $this->update_upc []= $elem26;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('PriceUpdateList');
    if ($this->shop_id !== null) {
      $xfer += $output->writeFieldBegin('shop_id', TType::STRING, 1);
      $xfer += $output->writeString($this->shop_id);
      $xfer += $output->writeFieldEnd();
    ...
    if ($this->update_upc !== null) {
      ...
      $xfer += $output->writeFieldBegin('update_upc', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRUCT, count($this->update_upc));
        {
          foreach ($this->update_upc as $iter27)
          {
...
class PriceUpdateUpc {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('PriceUpdateUpc');
    if ($this->barcode !== null) {
      $xfer += $output->writeFieldBegin('barcode', TType::STRING, 1);
      $xfer += $output->writeString($this->barcode);
      $xfer += $output->writeFieldEnd();
